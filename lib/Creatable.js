...
var compareOption = function compareOption() {
  ...
  var getOptionLabel = arguments.length > 2 ? arguments[2] : undefined;
  var getOptionValue = arguments.length > 3 ? arguments[3] : undefined;
  ...
  var optionValue = getStringValue(getOptionValue(option));
  var optionLabel = getStringValue(getOptionLabel(option));
...
var builtins = {
  ...
  isValidNewOption: function isValidNewOption(inputValue, selectValue, selectOptions, getOptionLabel, getOptionValue) {
    return !(!inputValue || selectValue.some(function (option) {
      return compareOption(inputValue, option, getOptionLabel, getOptionValue);
    ...
    _createClass(Creatable, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        var allowCreateWhileLoading = nextProps.allowCreateWhileLoading,
            ...
            getOptionLabel = nextProps.getOptionLabel,
            getOptionValue = nextProps.getOptionValue,
        ...
        if (isValidNewOption(inputValue, (0, _utils.cleanValue)(value), options, getOptionLabel, getOptionValue)) {
